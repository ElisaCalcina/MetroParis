...
public class MetroDAO {
	...
	public boolean fermateConnesse(Fermata fp, Fermata fa) {
		...
		try {
			...
			return linee>=1; //se linee >=1 torna vero, altrimenti falso
			//se COUNT >=1 vuol dire che ho almeno una connessione e quindi ho arco tra i due vertici
	...
	//query per metodo 2
	public List<Fermata> fermateSuccessive(Fermata fp, Map<Integer, Fermata> fermateIdMap){ //io ti do una fermata e tu mi restituisci una lista di fermate adiacenti
